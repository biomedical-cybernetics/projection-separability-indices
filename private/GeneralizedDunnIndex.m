...
function GDI = GeneralizedDunnIndex(a)
...
%
% indice=GeneralizedDunnIndex([{alfa} {beta} {gamma} {delta}]);
%
...
if (numeratore>0)
    %GDI = round(100*numeratore/denominatore)/100;
    GDI = numeratore/denominatore;
else
    GDI = 0;
end
